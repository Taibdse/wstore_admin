                ...
                <md-card-content>
                     <div class="md-layout md-gutter">
                         <div class="md-layout-item" style="text-align: right">
                            <md-button class="md-raised md-success" @click="gotoInsertProductPage">Add more products</md-button>
                         </div>
                    </div>
                        <div class="md-layout md-gutter">
                        <div class="md-layout-item md-size-50">
                            <md-field>
                                ...
                                <md-select v-model="filters.category" name="category" id="category">
                                    <md-option value="all">All</md-option>
                                    <md-option :value="cate.slug" v-for="(cate) in categories" :key="cate.id">{{ cate.name }}</md-option>
                                </md-select>
                            </md-field>
                            <md-button class="md-raised md-primary" @click="getProductsByCategory">Search</md-button>
                        </div>
                    </div>
                </md-card-content>
            </md-card>
...
export default {
    ...
    components: {
        ProductsList, Pagination, DropzoneUpload
    },
    ...
    methods: {
        getProducts: async function() {
            ...
            try {
                const res = await ProductService.getProducts(category, currentPage, size);
